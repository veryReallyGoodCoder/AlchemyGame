...
namespace Articy.Alchemyjam.Features
{
    ...
    public class DefaultExtendedCharacterFeatureFeature : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy.Alchemyjam.Features.DefaultExtendedCharacterFeatureFeature newClone = ((Articy.Alchemyjam.Features.DefaultExtendedCharacterFeatureFeature)(aClone));
        ...
        {
            Articy.Alchemyjam.Features.DefaultExtendedCharacterFeatureFeature clone = new Articy.Alchemyjam.Features.DefaultExtendedCharacterFeatureFeature();
