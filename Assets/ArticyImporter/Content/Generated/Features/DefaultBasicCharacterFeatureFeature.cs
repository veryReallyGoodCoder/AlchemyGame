...
namespace Articy.Alchemyjam.Features
{
    ...
    public class DefaultBasicCharacterFeatureFeature : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy.Alchemyjam.Features.DefaultBasicCharacterFeatureFeature newClone = ((Articy.Alchemyjam.Features.DefaultBasicCharacterFeatureFeature)(aClone));
            newClone.Age = Age;
        ...
        {
            Articy.Alchemyjam.Features.DefaultBasicCharacterFeatureFeature clone = new Articy.Alchemyjam.Features.DefaultBasicCharacterFeatureFeature();
