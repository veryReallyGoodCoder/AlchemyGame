...
namespace Articy.Alchemyjam
{
    ...
    public class DefaultSupportingCharacterTemplate : Entity, IEntity, IPropertyProvider, IObjectWithFeatureDefaultBasicCharacterFeature
    {
        ...
        private static Articy.Alchemyjam.Templates.DefaultSupportingCharacterTemplateTemplateConstraint mConstraints = new Articy.Alchemyjam.Templates.DefaultSupportingCharacterTemplateTemplateConstraint();
        
        public Articy.Alchemyjam.Templates.DefaultSupportingCharacterTemplateTemplate Template
        {
            get
            {
        ...
        public static Articy.Alchemyjam.Templates.DefaultSupportingCharacterTemplateTemplateConstraint Constraints
        {
            get
            {
                return mConstraints;
        ...
        protected override void CloneProperties(object aClone, Articy.Unity.ArticyObject aFirstClassParent)
        {
            ...
            if ((Template != null))
            {
                newClone.Template = ((Articy.Alchemyjam.Templates.DefaultSupportingCharacterTemplateTemplate)(Template.CloneObject(newClone, aFirstClassParent)));
            }
