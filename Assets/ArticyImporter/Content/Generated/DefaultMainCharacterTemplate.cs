...
namespace Articy.Alchemyjam
{
    ...
    public class DefaultMainCharacterTemplate : Entity, IEntity, IPropertyProvider, IObjectWithFeatureDefaultExtendedCharacterFeature, IObjectWithFeatureDefaultBasicCharacterFeature
    {
        ...
        private static Articy.Alchemyjam.Templates.DefaultMainCharacterTemplateTemplateConstraint mConstraints = new Articy.Alchemyjam.Templates.DefaultMainCharacterTemplateTemplateConstraint();
        
        public Articy.Alchemyjam.Templates.DefaultMainCharacterTemplateTemplate Template
        {
            get
            {
        ...
        public static Articy.Alchemyjam.Templates.DefaultMainCharacterTemplateTemplateConstraint Constraints
        {
            get
            {
                return mConstraints;
        ...
        protected override void CloneProperties(object aClone, Articy.Unity.ArticyObject aFirstClassParent)
        {
            ...
            if ((Template != null))
            {
                newClone.Template = ((Articy.Alchemyjam.Templates.DefaultMainCharacterTemplateTemplate)(Template.CloneObject(newClone, aFirstClassParent)));
            }
